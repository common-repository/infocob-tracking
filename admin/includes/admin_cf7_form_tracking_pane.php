<div class="control-box">
    <fieldset>
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row">
                    <label for="tracking_classes"><?php echo esc_html(__('Class', 'contact-form-7')); ?></label></th>
                <td><input type="text" name="class" class="classvalue oneline option" id="tracking_classes" /></td>
            </tr>
